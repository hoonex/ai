...
model = genai.GenerativeModel('gemini-1.5-pro') # 코딩 특화 Pro 모델 사용
...
if st.button("🚀 맞춤형 코드 생성 시작", type="primary", use_container_width=True):
    if not uploaded_file or not task_template:
        ...
        with st.spinner("학교 문법을 분석하여 템플릿에 맞게 코드를 작성 중입니다..."):
            ...
            4. 텍스트 설명은 주석으로만 달고, 주피터 노트북 셀에 그대로 '복사-붙여넣기' 할 수 있게 깔끔하게 작성해.
            ...
            try:
                ...
                st.info("아래 내용을 주피터 노트북에 그대로 복사해서 붙여넣기 하세요.")
